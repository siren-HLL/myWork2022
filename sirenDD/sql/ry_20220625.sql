...
create table sys_dept (
  ...
  ancestors         varchar(225)     default ''                 comment '祖级列表',
...
-- ----------------------------
-- 初始化-用户信息表数据admin123123xyz
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$RRTZzIBF1Nf47g4ZclIF1OOfTTe2ZGYODEENiToUPtWJxjibhrwuC', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'ry',    '若依', '00', 'ry@qq.com',  '15666666666', '1', '', '$2a$10$RRTZzIBF1Nf47g4ZclIF1OOfTTe2ZGYODEENiToUPtWJxjibhrwuC', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '测试员');
...
-- insert into sys_menu values('7', '监控事件', '0', '2', 'tunnelEvent',           null, '', 1, 0, 'M', '0', '0', '', 'tunnel',   'admin', sysdate(), '', null, '监控事件目录');
-- 二级菜单
...
insert into sys_config values(2, '用户管理-账号初始密码',         'sys.user.initPassword',         'a123456',        'Y', 'admin', sysdate(), '', null, '初始化密码 a123456' );
